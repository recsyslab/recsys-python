...
ユーザ$$u$$のユーザプロファイル$$\boldsymbol{p} _{u}$$を求めなさい。$$\boldsymbol{p}_{u}$$求めたユーザプロファイルを`pu`とすること。
...
ユーザ$$u$$が未評価のアイテム集合$$\bar{I}_{u}$$は次式のように定義される。



を取得しなさい。取得したアイテム集合を`Iu_not`とすること。
