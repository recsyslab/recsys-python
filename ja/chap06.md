...
### 10 固有値の降順にソートしたインデックス配列の取得
固有値`lmd`について、降順にソートしたインデックスの配列を`ndarray`として取得するコードを書きなさい。得られた`ndarray`を`indices`とすること。

```python
# 固有値の降順にソートしたインデックス配列を取得
【問題10】
...
### 11 固有値の降順に固有値配列をソート
固有値の降順にソートした固有値配列を`ndarray`として取得するコードを書きなさい。得られた`ndarray`を`lmd`とすること。
...
### 12 固有値の降順に固有ベクトル配列をソート
固有値の降順にソートした固有ベクトル配列を`ndarray`として取得するコードを書きなさい。得られた`ndarray`を`v`とすること。
